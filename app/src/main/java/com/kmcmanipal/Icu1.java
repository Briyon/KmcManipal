 ...
 */
public class Icu1 extends AppCompatActivity implements OnClickListener {
    int viewid;
    Button btnNext, btnbck;
    public Button scanBtn, scanbtn1;
    public View scan_view;
    ...
    private static final String table_id = "T4";
    private static final String table_name = "ICU-1";
    String ID;
    ...
    private static final int total_beds = 17;
    // private static final String icu_id = "ICU-1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_icu_1);
        ...
        scanbtn1 = (Button) findViewById(R.id.btn_scan1);
        res = (TextView) findViewById(R.id.scanres);
        ...
        /*textIn2.setOnClickListener(new OnClickListener() {
            @Override
                    ...
                    do {
                        ...
                        buttonEdit.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (!textIn1.getText().toString().isEmpty() || !textIn2.getText().toString().isEmpty()) {
                                    Toast.makeText(Icu1.this, "Update above fields and edit", Toast.LENGTH_LONG).show();
                                    return;
                                }
                                count -= 1;
                        ...
                        buttonDelete.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (ins == true) {
                                    Toast.makeText(Icu1.this, "STABLE PATIENT DATA DELETED", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(Icu1.this, "DELETING FAILED", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            ...
            buttonAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    buttonDelete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            boolean ins = mydb.delete_stable(table_id,
                                    ...
                                    textIn1.getText().toString());
                            if (ins == true) {
                                Toast.makeText(Icu1.this, "DELETED", Toast.LENGTH_SHORT).show();
                                buttonAdd.setText("ADD");
                                textIn1.setEnabled(true);
                                buttonDelete.setVisibility(View.INVISIBLE);
                                textIn1.setText("");
                                ...
                                Toast.makeText(Icu1.this, "FAILED", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    ...
                    if (buttonAdd.getText().equals("UPDATE")) {
                        ...
                        if (ins == true) {
                            Toast.makeText(Icu1.this, "UPDATED", Toast.LENGTH_SHORT).show();
                            buttonAdd.setText("ADD");
                            textIn1.setEnabled(true);
                            textOut2.setEnabled(false);
                            textOut1.setEnabled(false);
                            ...
                            Toast.makeText(Icu1.this, "UPDATE FAILED", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        boolean ins = mydb.insert_stable(table_id,
                                ...
                                textIn2.getText().toString());
                        if (ins == true) {
                              Toast.makeText(Icu1.this, "SAVED", Toast.LENGTH_SHORT).show();
                            textOut2.setEnabled(false);
                            textOut1.setEnabled(false);
            ...
            public void onClick(View v) {
                ...
                if (btnNext.getText().equals("SAVE")) {
                    ...
                    if (res)
                    {
                        ...
                        boolean res2 = mydb.insert_FLAGS(ID, null, null, chkdoc.isChecked(),  chkcln.isChecked(),
                                chkhk.isChecked(), editiss.getText().toString().trim(),
                                timeStamp, false, false, false, false, editcomm.getText().toString().trim());
    ...
    public void showMessage(boolean result, String title, String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Icu1.this);
        ...
        if (result) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    Intent i = new Intent(Icu1.this, Rounds.class);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_scan || v.getId() == R.id.btn_scan1) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (scanningResult != null) {
           ...
           /* if (viewid == 2131558557)
            ...
            if (scan_view.getId() == R.id.btn_scan)
                textIn1.setText(scanContent);
