 ...
 */
public class Icu2 extends AppCompatActivity implements View.OnClickListener
{
    ...
    private static final String table_id = "T5";
    private static final String table_name ="ICU-2";
    String ID;
    ...
    private static final int  total_beds=15;
    private static final String icu_id = "ICU-2";
    String cdate,timeStamp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_icu_2);
                    ...
                    do {
                        ...
                        buttonEdit.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (!textIn1.getText().toString().isEmpty() || !textIn2.getText().toString().isEmpty()) {
                                    Toast.makeText(Icu2.this, "Update above fields and edit", Toast.LENGTH_LONG).show();
                                    return;
                                }
                                count -= 1;
                        ...
                        buttonDelete.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (ins == true) {
                                    Toast.makeText(Icu2.this, "STABLE PATIENT DATA DELETED", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(Icu2.this, "DELETING FAILED", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                buttonDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        boolean ins = mydb.delete_stable(table_id,
                                ...
                                textIn1.getText().toString());
                        if (ins == true) {
                            Toast.makeText(Icu2.this, "DELETED", Toast.LENGTH_SHORT).show();
                            buttonAdd.setText("ADD");
                            textIn1.setEnabled(true);
                            buttonDelete.setVisibility(View.INVISIBLE);
                            textIn1.setText("");
                            ...
                            Toast.makeText(Icu2.this, "FAILED", Toast.LENGTH_SHORT).show();
                        }
                ...
                if (buttonAdd.getText().equals("UPDATE")) {
                    ...
                    if (ins) {
                        Toast.makeText(Icu2.this, "UPDATED", Toast.LENGTH_SHORT).show();
                        buttonAdd.setText("ADD");
                        textIn1.setEnabled(true);
                        textOut2.setEnabled(false);
                        textOut1.setEnabled(false);
                        ...
                        Toast.makeText(Icu2.this, "UPDATE FAILED", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    boolean ins = mydb.insert_stable(table_id,
                            ...
                            textIn2.getText().toString());
                    if (ins == true) {
                         Toast.makeText(Icu2.this, "SAVED", Toast.LENGTH_LONG).show();
                        textOut2.setEnabled(false);
                        textOut1.setEnabled(false);

                    } else {
                        Toast.makeText(Icu2.this, "FAILED", Toast.LENGTH_LONG).show();
                    }
                }
                textIn1.setText("");
                textIn2.setText("");
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(Icu2.this);
        ...
        if (result)
        {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    Intent i = new Intent(Icu2.this, Rounds.class);
