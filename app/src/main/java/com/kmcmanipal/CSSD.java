...
public class CSSD extends AppCompatActivity
{
    ...
    private static final String table_id = "T12";
    private static final String table_name = "CSSD";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_cssd);
        ...
        btnClick = (Button)findViewById(R.id.cssd_btnsave);

        chkavail = (CheckBox) findViewById(R.id.cssd_chk_avail);

        radioeqip=(RadioGroup)findViewById(R.id.cssd_rg_euip);
        radioyes=(RadioButton)findViewById(R.id.cssd_radioyes);
        radiono=(RadioButton)findViewById(R.id.cssd_radiono);
        comments=(EditText)findViewById(R.id.cssd_comments);
        ...
        btnClick.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            Toast myToast=Toast.makeText(CSSD.this, "Check value for Equipment Breakdown", Toast.LENGTH_LONG);
    ...
    public void showMessage(boolean result,String title,String message)
    {
        if (result)
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(CSSD.this);
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    mydb.close();
                    Intent i = new Intent(CSSD.this, Rounds.class);
