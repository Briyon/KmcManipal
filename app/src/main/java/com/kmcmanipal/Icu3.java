 ...
 */
public class Icu3 extends AppCompatActivity implements View.OnClickListener {
   ...
   // private static final String icu_id = "ICU-3";
    String cdate,timeStamp ;



    private static final String table_id = "T6";
    private static final String table_name ="ICU-3";
    String ID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_icu_3);
                ...
                do {
                    ...
                    buttonEdit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!textIn1.getText().toString().isEmpty() || !textIn2.getText().toString().isEmpty()) {
                                Toast.makeText(Icu3.this, "Update above fields and edit", Toast.LENGTH_LONG).show();
                                return;
                            }
                            count -= 1;
                    ...
                    buttonDelete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (ins == true) {
                                Toast.makeText(Icu3.this, "STABLE PATIENT DATA DELETED", Toast.LENGTH_LONG).show();
                                ...
                                Toast.makeText(Icu3.this, "DELETING FAILED", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                buttonDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        boolean ins = mydb.delete_stable(table_id,
                                ...
                                textIn1.getText().toString());
                        if (ins == true) {
                            Toast.makeText(Icu3.this, "DELETED", Toast.LENGTH_SHORT).show();
                            buttonAdd.setText("ADD");
                            textIn1.setEnabled(true);
                            buttonDelete.setVisibility(View.INVISIBLE);
                            textIn1.setText("");
                            ...
                            Toast.makeText(Icu3.this, "FAILED", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                if (count >= 1) {
                ...
                if (buttonAdd.getText().equals("UPDATE")) {
                    ...
                    if (ins == true) {
                        Toast.makeText(Icu3.this, "UPDATED", Toast.LENGTH_SHORT).show();
                        buttonAdd.setText("ADD");
                        textIn1.setEnabled(true);
                        textOut2.setEnabled(false);
                        textOut1.setEnabled(false);
                        ...
                        Toast.makeText(Icu3.this, "UPDATE FAILED", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    boolean ins = mydb.insert_stable(table_id,
                            ...
                            textIn2.getText().toString());
                    if (ins == true) {
                         Toast.makeText(Icu3.this, "SAVED", Toast.LENGTH_SHORT).show();
                        textOut2.setEnabled(false);
                        textOut1.setEnabled(false);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(Icu3.this);
        ...
        if (result)
        {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    Intent i = new Intent(Icu3.this, Rounds.class);
