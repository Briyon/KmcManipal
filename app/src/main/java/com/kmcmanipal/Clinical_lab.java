...
public class Clinical_lab extends AppCompatActivity
{
    ...
    private static final String table_id = "T11";
    private static final String table_name = "Clinical-Lab";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_clinical_lab);
        ...
        btnClick = (Button)findViewById(R.id.cli_btn_save);

        chkavail = (CheckBox) findViewById(R.id.cli_avail);
        radioeqip=(RadioGroup)findViewById(R.id.cli_radioGroup);
        radioyes=(RadioButton)findViewById(R.id.cli_radioyes);
        radiono=(RadioButton)findViewById(R.id.cli_radiono);
        comments=(EditText)findViewById(R.id.cli_comments);
        ...
        btnClick.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            Toast myToast=Toast.makeText(Clinical_lab.this, "Check value for Equipment Breakdown", Toast.LENGTH_LONG);
                        ...
                        btn=(Button)findViewById(select_id);
    ...
    public void showMessage(boolean result,String title,String message) {
        if (result) {
            AlertDialog.Builder builder = new AlertDialog.Builder(Clinical_lab.this);
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    mydb.close();
                    Intent i = new Intent(Clinical_lab.this, Rounds.class);
